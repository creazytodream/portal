...
public class JXLExcelView extends AbstractJExcelView {
    ...
    //表格的的列名
    private String[] columnNames = new String[] { "编号", "姓名", "年龄", "密码", "性别",
            "地址" };

    //这里要和javabean的名字对应
    private String[] dbColumnNames = new String[] { "id", "name", "age",
            "password", "sex","address" };

    //这里设置表格的列宽
    private Integer[] columnWidths = new Integer[] { 30, 30, 30, 30, 30, 30 };
